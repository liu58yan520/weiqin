...
class Order_EweiShopV2Page extends CashierWebPage 
{
	public function main() 
	{
		...
		{
			set_time_limit(0);
			$columns = array( array('title' => '状态', 'field' => 'status', 'width' => 12), array('title' => '订单号', 'field' => 'logno', 'width' => 24), array('title' => '付款日期', 'field' => 'createtime', 'width' => 24), array('title' => '操作员', 'field' => 'operator', 'width' => 12), array('title' => '支付方式', 'field' => 'paytype', 'width' => 12), array('title' => '金额', 'field' => 'money', 'width' => 12), array('title' => '商品金额', 'field' => 'goodsprice', 'width' => 12), array('title' => '商城商品', 'field' => 'orderprice', 'width' => 12), array('title' => '随机减', 'field' => 'randommoney', 'width' => 12), array('title' => '满额减', 'field' => 'enough', 'width' => 12), array('title' => '余额抵扣', 'field' => 'deduction', 'width' => 12), array('title' => '固定折扣', 'field' => 'discountmoney', 'width' => 12), array('title' => '优惠券减免', 'field' => 'usecouponprice', 'width' => 12), array('title' => '赠送积分', 'field' => 'present_credit1', 'width' => 12) );
			foreach ($list as $k => &$v ) 
			{
				if ($v['status'] == '1') 
				{
